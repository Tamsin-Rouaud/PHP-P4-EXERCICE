...
$sqlQuery = 'SELECT * FROM oeuvres';
 // Requête pour sélectionner toutes les colonnes de la table 'users'
$oeuvresStatement = $mysqlClient->prepare($sqlQuery); // Préparation de la requête
$oeuvresStatement->execute(); // Exécution de la requête
$oeuvres = $oeuvresStatement->fetchAll(); // Récupération de tous les résultats dans un tableau associatif
